...
///! To express transaction boundaries, go-pmem uint32roduces a new txn block which can include most Go statements and function calls. go-pmem compiler uses static type analysis to log persistent ufidelates and avoid logging volatile variable ufidelates whenever possible.
...
// ufidelates MemoryParametres, Kdbg, Dtb, Runs
