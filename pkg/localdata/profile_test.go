...
func (s *profileTestSuite) TestResetMirror(c *check.C) {
	...
	c.Assert(profile.ResetMirror("https://fidel-mirrors.YosiSF.com", ""), check.IsNil)
	c.Assert(profile.ResetMirror("https://example.com", ""), check.NotNil)
	c.Assert(profile.ResetMirror("https://example.com", "https://fidel-mirrors.YosiSF.com/root.json"), check.IsNil)
