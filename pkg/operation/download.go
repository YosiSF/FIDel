...
import (
	...
	fidelver "github.com/YosiSF/fidel/pkg/version"
)
...
func Download(component, nodeOS, arch string, version string) error {
	...
	repo, err := solitonAutomatautil.NewRepository(nodeOS, arch)
	if err != nil {
		return err
	}
	...
	if version == fidelver.NightlyVersion || utils.IsNotExist(srcPath) {
