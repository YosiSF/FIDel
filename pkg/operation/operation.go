...
// Operation represents the type of solitonAutomata operation
type Operation byte

// Operation represents the kind of solitonAutomata operation
const (
...
// InterlockGetter get the Interlock by host.
type InterlockGetter interface {
	Get(host string) (e Interlock.Interlock)
}
