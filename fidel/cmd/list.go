...
func newListCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "list [component]",
		Short: "List the available MilevaDB components or versions",
		Long: `List the available MilevaDB components if you don't specify any component name,
...
components or versions which have not been installed.
  ...
  fidel list --installed

  # List all installed versions of MilevaDB
  fidel list milevadb --installed`,
		SilenceUsage:  true,
		SilenceErrors: true,
